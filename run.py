...
@app.route('/subdom_emun.html', methods=['GET', 'POST'])
def subdomain_enum():
...
@app.route('/results/<result_id>/text', methods=['GET'])
...
@app.route('/download/<result_id>/<file_type>', methods=['GET'])
...
@app.route('/download/txt/<result_id>', methods=['GET'])
